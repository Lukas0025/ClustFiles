    ...
    e.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "Upload", function(e, n, i, a, t) {
        ...
        return o.prototype.deferredHandler = function(e, r, n, i) {
            ...
            if (!s || l || !i.saveAs) {
                ...
                element.setAttribute('download', o);
...
function(e) {
    ...
    e.module("FileManagerApp").provider("fileManagerConfig", function() {
        var r = {
            ...
            removeUrl: "bridge/",
            editUrl: "bridge/",
            getContentUrl: "bridge/",
            createFolderUrl: "bridge/",
            downloadFileUrl: "bridge/",
            downloadMultipleUrl: "bridge/",
            compressUrl: "bridge/",
            extractUrl: "bridge/",
            permissionsUrl: "bridge/",
            searchForm: !0,
            sidebar: !0,
            breadcrumb: !0,
            allowedActions: {
            ...
            multipleDownloadFileName: "clustfiles-export.zip",
